package com.genuinecoder.movie_streaming_service.controller;
...
public class MovieStreamController {
    private static Logger log = Logger.getLogger(MovieStreamController.class.getName());
    public static final String VIDEO_DIRECTORY = "E:\\Stream\\";
